...
// 포뻥 종류
// "보스이름" : ["보스의레벨","포스종류","포뻥데미지%","포뻥요구포스","입장요구포스"]
    "익스트림 몬스터파크": ["260","없음","없음","없음","없음"],

    "노말 시그너스": ["190","없음","없음","없음","없음"],
    "카오스 벨룸": ["190","없음","없음","없음","없음"],
    "하드 매그너스": ["190","없음","없음","없음","없음"],
    "카오스 파풀라투스": ["190","없음","없음","없음","없음"],
    "노말 스우": ["210","없음","없음","없음","없음"],
    "노말 데미안": ["210","없음","없음","없음","없음"],
    "노말 가엔슬": ["220","없음","없음","없음","없음"],

    "이지 루시드": ["230","아케인","150%","540","360"],
    "노말 루시드": ["230","아케인","150%","540","360"],
    "이지 윌": ["250","아케인","150%","840","560"],
    "노말 윌": ["250","아케인","150%","1140","760"],
    "노말 듄켈": ["265","아케인","150%","1095","850"],
    "노말 더스크": ["255","아케인","150%","730","730"],

    "하드 스우": ["210","없음","없음","없음","없음"],//스데미도 포뻥없음
    "익스트림 스우": ["210","없음","없음","없음","없음"],//스데미도 포뻥없음
    "하드 데미안": ["210","없음","없음","없음","없음"],//스데미도 포뻥없음
    "카오스 가엔슬": ["220","없음","없음","없음","없음"],//가엔슬은 메이플랜드라서 포뻥없음
    "하드 루시드": ["230","아케인","150%","540","360"],
    "하드 윌": ["250","아케인","150%","1140","760"],
    "노말 진 힐라": ["250","아케인","150%","1230","820"],
    "카오스 더스크": ["255","아케인","150%","1095","730"],
    "하드 진 힐라": ["250","아케인","150%","1350","900"],
    "하드 듄켈": ["265","아케인","150%","1275","850"],
    "하드 검은 마법사": ["275","아케인","100%","1320","1320"],
    "익스트림 검은 마법사": ["280","아케인","100%","1320","1320"],

    "노말 세렌": ["270","어센틱","125%","250","200"],
    "이지 칼로스": ["270","어센틱","125%","250","200"],
    "하드 세렌": ["275","어센틱","125%","250","200"],
    "노말 칼로스": ["280","어센틱","125%","350","300"],
    "이지 카링": ["275","어센틱","125%","280","230"],
    "노말 림보": ["285","어센틱",'125%',"550","500"],
    "노말 카링": ["285","어센틱","125%","380","330"],
    "카오스 칼로스": ["285","어센틱","125%","380","330"],
    "익스트림 세렌": ["280","어센틱","125%","250","200"],
    "하드 림보": ["285","어센틱",'125%',"550","500"],
    "하드 카링": ["285","어센틱","125%","400","350"],
    "익스트림 카링": ["285","어센틱","125%","530","480"],
    "익스트림 칼로스": ["285","어센틱","125%","490","440"],
};
...
function modalCheckBossForceToolTip(characterForce, bossName) {
    ...
    if (modalHeader) {
        ...
        infoDiv.innerHTML = `<strong>보스 레벨:</strong> ${forceAdvantage[bossName][0]} <br><strong>입장 포스:</strong> ${forceAdvantage[bossName][4] || '없음'} <br><strong>포뻥 포스:</strong> ${forceAdvantage[bossName][3] || '없음'}`;
    }
}
